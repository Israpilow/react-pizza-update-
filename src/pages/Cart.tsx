...
import { setRemoveCart, setPlusItem, setMinusItem, setDeleteCart } from '../redux/actions/cart';
          ...
          <div className="cart">
            <div className="cart__top">
              ...
              <div className="cart__clear">
                ...
                <span onClick={onDeleteCart}>Очистить корзину</span>
              </div>
            </div>
            ...
            <div className="cart__bottom">
              ...
              <div className="cart__bottom-buttons">
                ...
                <div onClick={onPayCart} className="button pay-btn">
